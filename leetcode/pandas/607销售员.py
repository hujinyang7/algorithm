...
def sales_person(sales_person: pd.DataFrame, company: pd.DataFrame, orders: pd.DataFrame) -> pd.DataFrame:
    red_com_df = company.loc[company['name'] == 'RED', ['com_id']]
    red_com_id = [] if red_com_df.empty else red_com_df['com_id'].to_list()
    red_sales_ids = orders.loc[orders['com_id'].isin(red_com_id), ['sales_id']]['sales_id'].to_list()
